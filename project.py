...
# TODO file name al, p.json  yerine yaz, function içine al,0 seçeneği ekle, değer girerken updatte none girebilir
# TODO object ıd ile değiştir, id yi sil, delette
...
if __name__ == "__main__":
    ...
    if zero_option == 0:
        file_path = str(input("Please enter JSON file path: "))
        fileOperation(file_path)  # function call
    '''
